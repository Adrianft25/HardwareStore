...
<body class="d-flex flex-column h-100">
	<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="barra">
		...
		<div id="my-nav" class="collapse navbar-collapse">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active">
					<a class="nav-link" href="Register.php">Ubicación<span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item active">
	...
	<div class="container col-2">
		<form id="formIni" class="form-signin" method="POST" action="prueba.php">
			<h1 class="h3 mb-3 font-weight-normal text-center">Regístrate</h1>
			<label for="" class="sr-only">Username</label>
			<input class="form-control" type="text" name="usernm2" maxlength="25" placeholder="Nombre de usuario" id="user" autofocus required>
			<label for="" class="sr-only">Password</label>
			<input class="form-control" type="password" maxlength="25" id="pass" name="passwd2" placeholder="Contraseña" required>
			<label for="" class="sr-only">Email</label>
			<input class="form-control" type="mail" name="email2" maxlength="25" placeholder="Correo Electrónico" id="correo" required>
			<label for="inputPassword" class="sr-only">Movil</label>
			<input class="form-control" type="tel" name="movil2" maxlength="25" placeholder="Teléfono Móvil" id="telefono" required>
			<br>
