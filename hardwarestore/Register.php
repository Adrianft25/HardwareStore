...
<body class="d-flex flex-column h-100">
	...
	<div class="container col-2">
		<form id="formIni" class="form-signin" method="POST" action="prueba2.php">
			...
			<p>Si aún no tienes cuenta puedes <a href="Register2.php" id="registlink">registrarte aquí</a>.</p>
		</form>
<?php
